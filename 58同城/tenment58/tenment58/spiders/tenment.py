...
class TenmentSpider(scrapy.Spider):
    name = 'tenment'
    ...
    def get_tenment(self,response):
        ...
        housing_types = response.xpath('/html/body/div[4]/div[2]/div[2]/div[1]/div[1]/ul/li[2]/span[2]/text()').extract_first()
        community = response.xpath('/html/body/div[4]/div[2]/div[2]/div[1]/div[1]/ul/li[4]/span[2]/a/text()').extract_first()
        iphone = response.xpath('/html/body/div[4]/div[2]/div[2]/div[2]/div[1]/span/text()').extract_first()
        area=response.xpath('/html/body/div[4]/div[2]/div[2]/div[1]/div[1]/ul/li[5]/span[2]/a//text()').extract_first()
    ...
    def parse(self, response):
        ...
        for div in div_list:
            url = div.xpath('.//div[@class="img_list"]/a/@href').extract_first()
            new_url = 'https:' + url
